        ...
        <div>
            ...
            <div className="flex flex-wrap ml-12  ">
                ...
                <div>
                    ...
                    <h5 className=' text-blue-900 font-bold mb-4'>SELL VS REVENUE</h5>
                ...
                <div>
                    <h5 className='text-blue-900 font-bold mt-20'>Sell vs Investment</h5>
                    <BarChart className='mt-6' width={500} height={250} data={data}>
                        <CartesianGrid strokeDasharray="3 3" />
                        <XAxis dataKey="month" />
                        <YAxis />
                        <Tooltip />
